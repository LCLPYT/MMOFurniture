...
import work.lclpnet.mmofurniture.module.DeskCabinetModule;

public class DeskCabinetBlockEntity extends BasicLootBlockEntity implements OpenableContainer {

    private final ViewerCountManager stateManager;

    public DeskCabinetBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(DeskCabinetModule.blockEntityType, blockPos, blockState);
    ...
    protected Text getContainerName() {
        return new TranslatableText("container.cfm.desk_cabinet");
    }
    ...
    public void playOpenSound(BlockState blockState, SoundEvent soundEvent) {
        Vec3i directionVec = blockState.get(DeskCabinetBlock.DIRECTION).getVector();
